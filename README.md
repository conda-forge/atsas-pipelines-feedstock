About atsas-pipelines-feedstock
===============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/atsas-pipelines-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13247&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/atsas-pipelines-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `atsas-pipelines` can be installed with `conda`:
...
```
mamba install atsas-pipelines
```

It is possible to list all of the versions of `atsas-pipelines` available on your platform with `conda`:
...
```
mamba search atsas-pipelines --channel conda-forge
```
...
mamba repoquery search atsas-pipelines --channel conda-forge

# List packages depending on `atsas-pipelines`:
mamba repoquery whoneeds atsas-pipelines --channel conda-forge

# List dependencies of `atsas-pipelines`:
mamba repoquery depends atsas-pipelines --channel conda-forge
```
